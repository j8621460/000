...
|---|---|---|
| `libusque.so` (13 MB) | `app/src/main/jniLibs/arm64-v8a/` | `github.com/diniboy1123/usque` (Go, MIT) |
| `firestack.aar` | `app/libs/` | `github.com/j8621460/firestack`, rama `gostr` (Go, MPL-2.0) |
...
```yaml
RepoType: git
Repo: https://github.com/diniboy1123/usque.git
```

`srclibs/firestack.yml`
```yaml
RepoType: git
Repo: https://github.com/j8621460/firestack.git
```
...
deja de ser reproducible, que es justo lo que F-Droid verifica.
